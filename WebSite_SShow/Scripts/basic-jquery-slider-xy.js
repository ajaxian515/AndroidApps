     ...
     $.fn.bjqsx = function (options) {
         ...
         var settings = {},
            defaults = {
                ...
                nextText: '<img alt="" src="SiteImages/SiteStrucImages/imgNext.png" />',
                prevText: '<img alt="" src="SiteImages/SiteStrucImages/imgPrev.png" />',
         ...
         if (settings.showMarkers && slideCount > 1) {
             ...
             $markerContainer.css('margin-top', '-200px');
         ...
         if (settings.useCaptions) {
             ...
             $.each(slides, function (key, value) {
                 ...
                 var desc = $slideChild.attr('alt');
                 var adverb = $slideChild.attr('itemref');
                 var movschedule = $slideChild.attr('lang');
                 ...
                 $slideChild.css('width', GlobalWidth + 'px').css('height', nHeight + 'px');

                 if (title) {

                     var $caption;

                     if (movschedule == undefined) { movschedule = ''; }
                     if (desc == undefined) { desc = ''; }
                     if (adverb == undefined) { adverb = ''; }

                     $caption = $('<p class="bjqs-italic-action"><i>' + adverb + '</i></p><div class="bjqs-main-caption">' + title + '</div><div class="bjqs-main-schedule">' + movschedule + '</div><div class="bjqs-main-desc">' + desc + '</div>');

                                           
                     $('.bjqs-caption').css({ opacity: 0.8 });
                     $caption.appendTo($slide);
                     $('#slideshow-caption').css('margin-left', '-100px');
                 }

             });

             
             $('.bjqs-caption').css({ opacity: 0.6 });
             $('.bjqs-caption>a').css({ opacity: 1.0 });
